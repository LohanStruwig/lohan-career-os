...
- screenshots or examples containing private names, contact details, account records, or confidential data.
...
Do not invent missing proof. If a source artifact, metric, screenshot, reference, or delivery record is unavailable, incomplete, private, or unsuitable for public release, leave that limitation visible and use restrained wording.

Absence of artifacts should not be filled with unsupported claims. Public credibility depends on selected, reviewable proof and honest context, not on reconstructing evidence that is not available for publication.
...
- `career-profile.md`
- `portfolio-content/founder-profile.md`
- `portfolio-content/venturelayer-credibility-page.md`
- `case-studies/`
- `capability-blocks/`
